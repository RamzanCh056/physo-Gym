...
class WomenMixWorkoutScreen extends StatefulWidget {
  const WomenMixWorkoutScreen({Key? key}) : super(key: key);

  @override
  State<WomenMixWorkoutScreen> createState() => _WomenMixWorkoutScreenState();
}

class _WomenMixWorkoutScreenState extends State<WomenMixWorkoutScreen> {
  ...
  getChestVideo() {
    ...
    try {
      ...
      FirebaseFirestore.instance
          .collection(StaticInfo.womenMixWorkout)
          .snapshots()
          .listen((event) {
        getData.clear();
        setState(() {});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Women Mix workout videos", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
        centerTitle: true,
