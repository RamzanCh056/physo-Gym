...
class WomenYogaWorkoutScreen extends StatefulWidget {
  const WomenYogaWorkoutScreen({Key? key}) : super(key: key);

  @override
  State<WomenYogaWorkoutScreen> createState() => _WomenYogaWorkoutScreenState();
}

class _WomenYogaWorkoutScreenState extends State<WomenYogaWorkoutScreen> {
  ...
  getChestVideo() {
    ...
    try {
      ...
      FirebaseFirestore.instance
          .collection(StaticInfo.womenYogaWorkout)
          .snapshots()
          .listen((event) {
        getData.clear();
        setState(() {});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Women Yoga training videos", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold),),
        centerTitle: true,
