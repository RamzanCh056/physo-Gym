...
class AddWomenMixWorkout extends StatefulWidget {
  AddWomenMixWorkout({Key? key}) : super(key: key);


  @override
  State<AddWomenMixWorkout> createState() => _AddWomenMixWorkoutState();
}

class _AddWomenMixWorkoutState extends State<AddWomenMixWorkout> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Women Mix workout"),
        centerTitle: true,
      ),
      body: Padding(
