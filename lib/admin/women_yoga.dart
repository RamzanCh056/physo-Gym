...
class AddWomenYogaWorkout extends StatefulWidget {
  AddWomenYogaWorkout({Key? key}) : super(key: key);


  @override
  State<AddWomenYogaWorkout> createState() => _AddWomenYogaWorkoutState();
}

class _AddWomenYogaWorkoutState extends State<AddWomenYogaWorkout> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Women yoga workout"),
        centerTitle: true,
      ),
      body: Padding(
